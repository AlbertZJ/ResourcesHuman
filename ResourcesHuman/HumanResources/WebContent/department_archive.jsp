...
<center>
<font face="楷体"   size="6" color="#000">部门的删除和修改</font>
	<form name="formName" action = "a_department.jsp" method = "post" onsubmit = "return do_action()">
  	<table      border="1"  >
  	  <tr    height="10">
      ...
      <td><input type="checkbox" name="no"  
						value="${row.id}"></td>
	 			  <td>
	 			  <input type="text" name="id" value="${row.id}" readonly="readonly"/>
	 			 
	 			 </td>
	 			 <td>
	 			  <input type="text" name="department${row.id}" value="${row.department}" maxlength = "10"/>
