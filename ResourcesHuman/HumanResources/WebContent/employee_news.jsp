...
SELECT * from think;
 ...
 <center> 
	 <font face="楷体" size="6" color="#000"  >添加员工信息</font>  
	</center>
	<form action = "add_employee.jsp" method = "post" onsubmit = "return validate()" style="center">
  	<table width="300" height = "180" border="5"  align="center" bordercolor="#A0A0A0"   >
  	  ...
  	  <tr>
		<th>员工的姓名：</th>
		<td   ><input type="text"  name="e_name" title="输入员工的姓名" maxlength = "7" required="required" ></td>
 	  </tr>
 	  <tr>
 		<th  >性别：</th>
 	  ...
 	  <tr> 
 		<th>年龄：</th>
 		<td   ><input type="number" name="age" min="18" max="80" required="required" ></td>
 	  </tr>
 	  <tr>
 		<th>学历：</th>
 		<td>
 	  ...
 	  <tr>
 		<th>毕业时间：</th>
 		<td>
 		<input type="date" name="grad_time" required="required"/>
