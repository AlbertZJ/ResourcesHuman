...
<center>
<font face="楷体"   size="6" color="#000">工作岗位删除和修改</font>
	<form name="formName" action = "a_post.jsp" method = "post" onsubmit = "return do_action()">
      ...
      <td><input type="checkbox" name="no"  
	 			 ...
	 			 <td>
	 			  <input type="text" name="post${row.id}" value="${row.post}" maxlength = "10" />
