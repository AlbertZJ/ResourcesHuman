...
<center>
<font face="楷体"   size="6" color="#000">专业的删除和修改</font>
	<form name="formName" action = "a_speciality.jsp" method = "post" onsubmit = "return do_action()">
  	<table      border="1"  >
  	  <tr    height="10">
      ...
      <td><input type="checkbox" name="no" title="选择/不选择"
	 			 ...
	 			 <td>
	 			  <input type="text" name="speciality${row.id}" value="${row.speciality}" maxlength = "10"/>
